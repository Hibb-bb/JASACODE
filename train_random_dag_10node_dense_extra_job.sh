...
#SBATCH --job-name=rdag_10n_ex
#SBATCH --array=0-1
#SBATCH --nodes=1
#SBATCH --output=/projects/p32626/JASACODE/slurm_log/slurm_rdag10extra_%A_%a.out
#SBATCH --error=/projects/p32626/JASACODE/slurm_log/slurm_rdag10extra_%A_%a.err
...
echo "=========================================="
echo "Random DAG Training — 10 Nodes, Dense (extra seeds)"
