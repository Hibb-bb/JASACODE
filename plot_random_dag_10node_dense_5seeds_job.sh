...
#SBATCH --job-name=plot_rdag10_5s
#SBATCH --nodes=1
#SBATCH --output=/projects/p32626/JASACODE/slurm_log/slurm_plot_rdag10_5s_%j.out
#SBATCH --error=/projects/p32626/JASACODE/slurm_log/slurm_plot_rdag10_5s_%j.err
